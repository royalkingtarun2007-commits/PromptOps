...
function requireApiKey(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var authHeader, rawKey, keyHash, result, key, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, pool_1.db.query("SELECT id, workspace_id, name, expires_at\n       FROM api_keys\n       WHERE key_hash = $1\n       LIMIT 1", [keyHash])];
                case 2:
                    result = _a.sent();
                    key = result.rows[0];
                    if (!key) {
                    ...
                    void pool_1.db.query('UPDATE api_keys SET last_used_at = NOW() WHERE id = $1', [key.id]);
                    req.auth = {
